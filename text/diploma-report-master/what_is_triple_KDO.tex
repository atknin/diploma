...
\begin{figure}[H]
  \centering
  \subfloat[главный пик]{\includegraphics[width=0.325\textwidth]{images/triple_map_g.png}\label{ris:triple_map_piks_g}}
  \hfill
  \subfloat[псевдо пик монохроматора]{\includegraphics[width=0.325\textwidth]{images/triple_map_m.png} \label{ris:triple_map_piks_m}}
  \hfill
  \subfloat[псевдо пик анализатора]{\includegraphics[width=0.325\textwidth]{images/triple_map_a.png} \label{ris:triple_map_piks_a}}
