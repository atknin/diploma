...
\long\def\@makecaption#1#2{%
  ...
  \hbox to\textwidth{\hfill\parbox{1\textwidth}{#1 - #2}\hfill}
...
\section{Результаты и обсуждения}
  ...
  \subsection{Влияние внешнего электрического поля на двухкристальные КДО}
    ...
    \subsubsection{Изменение профиля КДО}
      \subsubsubsection{Сохранение структурного фактора}
      \subsubsubsection{Уширение за счет дисперсии}
    \subsubsection{Угловой сдвиг КДО}
    \newpage
