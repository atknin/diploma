...
Если в элементарной ячейке более одного атома, волны от разных атомов,
 ...
 \begin{figure}[H]
   \centering
   \subfloat[Коструктивная интерференция]{\includegraphics[width=0.45\textwidth]{images/interference_construct.png}}
   \hfill
   \subfloat[Деструктивная интерференция]{\includegraphics[width=0.45\textwidth]{images/interference_destruct.png}}
